document.write(`
    ...
    <style>
        ...
        #chatbar{
		    background-color: rgb(60, 219, 168);
		}
        .bot-msg{
	...
	<div id='1' class='text bot-msg' style='display: none;'>hejjj</div><div id='2'class='2 input_CB bot-msg' style='display: none;'>completed?</div><div id='3' class='text bot-msg' style='display: none;'>widaomo ze tak!</div><div id='4a' class='multiple multiple-btn' onclick='option_choosen(this.id)' style='display: none;'>chce podac maila</div><div id='4b' class='multiple multiple-btn' onclick='option_choosen(this.id)' style='display: none;'>chce podac telefon</div><div id='5b'class='5 phone bot-msg' style='display: none;'>podaj wiec tel</div><div id='5a'class='6 email bot-msg' style='display: none;'>podaj wiec maila</div><div id='6a' class='text bot-msg' style='display: none;'>dzieki za maila</div><div id='6b' class='text bot-msg' style='display: none;'>dzieki za numer telefonu</div>
	</div>
`);
