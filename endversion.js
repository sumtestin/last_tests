document.write(`
    ...
    <style>
        ...
        #chatbar{
		    background-color: rgb(112, 93, 148);
		}
        .bot-msg{
			background-color: rgb(117, 206, 125);
	...
	<div id='1' class='text bot-msg' style='display: none;'>hejka ?</div><div id='2a' class='multiple multiple-btn' onclick='option_choosen(this.id)' style='display: none;'>wda</div><div id='2b' class='multiple multiple-btn' onclick='option_choosen(this.id)' style='display: none;'>dwa</div><div id='3a' class='text bot-msg' style='display: none;'>lekko jest teraz</div><div id='3b' class='4 bot-msg' style='display: none;'>rano</div><div id='4ba' class='multiple multiple-btn' onclick='option_choosen(this.id)' style='display: none;'>tak</div><div id='4bb' class='multiple multiple-btn' onclick='option_choosen(this.id)' style='display: none;'>nie</div><div id='5ba'class='6 input_CB bot-msg' style='display: none;'>poada j</div><div id='5bb' class='text bot-msg' style='display: none;'>ogogogog ? -</div>
	</div>
`);
